...
class ForumTopicsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $threads = $forumtopic->forumThreads()->paginate(30);
        return view('member.forum-topics.show', compact('forumtopic','threads'));
    }
    ...
    public function update(Request $request, $id)
    {
       ...
       $thread= $forumtopic->forumThreads()->create([
        ...
        return redirect('member/forum-topics/'.$forumtopic->id)->with('flash_message', __('admin.changes-saved'));
    }
