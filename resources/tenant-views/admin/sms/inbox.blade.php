                                    ...
                                    <table class="table table-hover table-mailbox">
                                        ...
                                        @foreach($sms as $item)
                                            ...
                                            <tr >
                                                ...
                                                <td class="clickable"><a  style="width: 100%; height: 100%">{!! clean( nl2br($item->message)) !!}</a>
                                                </td>
                                                ...
                                                <td>
                                                    <a  href="{{ route('sms.delete-inbox',['sms'=>$item->id]) }}"  title="@lang('site.delete')" onclick="return confirm('@lang('admin.delete-prompt')')" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
