                                    ...
                                    <table class="table table-hover table-mailbox">
                                        ...
                                        @foreach($sms as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td  onclick="document.location.replace('{{ url('/admin/sms/' . $item->id) }}')"  class="clickable"><a  style="width: 100%; height: 100%" href="{{ url('/admin/sms/' . $item->id) }}">{!! clean( nl2br($item->message)) !!}</a>
                                                </td>
