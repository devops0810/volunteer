...
@section('breadcrumb')
    ...
    <li><a href="{{ url('/admin/emails') }}">@lang('admin.sent-messages')</a> <span class="bread-slash">/</span>
    </li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-payment-inner-st">
                        <ul id="myTabedu1" class="tab-review-design">
                            ...
                            <li><a href="#reviews"> @lang('admin.recipients'): @lang('admin.members') ({{ $email->users()->count() }})</a></li>
                            <li><a href="#INFORMATION">@lang('admin.recipients'): @lang('admin.departments') ({{ $email->departments()->count() }})</a></li>
                        </ul>
                                        ...
                                        <div class="hpanel email-compose mailbox-view">
                                            ...
                                            <div class="border-bottom border-left border-right bg-white mg-tb-15">
                                                <p class="m-b-md">
                                                    ...
                                                    <a href="{{ route('email.download-attachments',['email'=>$email->id]) }}" class="btn btn-default btn-xs">@lang('admin.download-all') <i class="fa fa-file-zip-o"></i> </a>
                                                </p>

                                                <div>
                                                    <div class="row">
                                                        @foreach($email->emailAttachments as $attachment)
                                                            <a href="{{ route('email.download-attachment',['emailAttachment'=>$attachment->id]) }}">
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">

                                                            <div class="hpanel vw-mb">
                                                                <div class="panel-body file-body incon-ctn-view" >
                                                                    @if(isImage($attachment->file_path))
                                                                        <img style="max-height: 270px" src="{{ route('email.view-image',['emailAttachment'=>$attachment->id]) }}" class="img-responsive img-center" alt=""/>
                                                                     @else
                                            ...
                                            <div class="panel-footer text-right ft-pn">
                                                <div class="btn-group active-hook">
                                                    ...
                                                    <a onclick="return confirm('@lang('admin.delete-prompt')')"  class="btn btn-default" href="{{ route('email.delete',['id'=>$email->id]) }}"><i class="fa fa-trash-o"></i> @lang('admin.delete')</a>
                                                </div>
                                            </div>
                                        </div>
