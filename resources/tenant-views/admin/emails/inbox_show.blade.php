...
@section('breadcrumb')
    ...
    <li><a href="{{ route('emails.inbox') }}">@lang('admin.inbox')</a> <span class="bread-slash">/</span>
    </li>
                ...
                <div class="hpanel email-compose mailbox-view">
                    ...
                    <div class="panel-footer text-right ft-pn">
                        <div class="btn-group active-hook">
                            <a href="{{ url('admin/emails/create') }}?reply={{ $email->id }}" class="btn btn-default"><i class="fa fa-reply"></i> @lang('admin.reply')</a>
                            <button onclick="printPageArea('mailContent')" class="btn btn-default"><i class="fa fa-print"></i> @lang('admin.print')</button>

                            <a onclick="return confirm('@lang('admin.delete-prompt')')"  class="btn btn-default" href="{{ route('email.delete-inbox',['id'=>$email->id]) }}"><i class="fa fa-trash-o"></i> @lang('admin.delete')</a>
                        </div>
                    </div>
                </div>
