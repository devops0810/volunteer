...
@section('breadcrumb')
    ...
    <li><span class="bread-blod">@lang('admin.sent-sms')</span>
    </li>
@endsection
                                    ...
                                    <table class="table table-hover table-mailbox">
                                        ...
                                        @foreach($sms as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td  onclick="document.location.replace('{{ url('/member/sms/' . $item->id) }}')"  class="clickable"><a  style="width: 100%; height: 100%" href="{{ url('/member/sms/' . $item->id) }}">{!! clean( nl2br(clean($item->message))) !!}</a>
                                                </td>
                                                ...
                                                <td>
                                                    <a  href="{{ route('member.sms.delete',['id'=>$item->id]) }}"  title="@lang('site.delete')" onclick="return confirm('@lang('admin.delete-prompt')')" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
