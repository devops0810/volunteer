...
@section('breadcrumb')
    ...
    <li><a href="{{ url('/member/sms') }}">@lang('admin.sent-sms')</a> <span class="bread-slash">/</span>
    </li>
                                        ...
                                        <div class="hpanel email-compose mailbox-view">
                                            ...
                                            <div class="panel-footer text-right ft-pn">
                                                <div class="btn-group active-hook">
                                                    ...
                                                    <a onclick="return confirm('@lang('admin.delete-prompt')')"  class="btn btn-default" href="{{ route('member.sms.delete',['id'=>$sms->id]) }}"><i class="fa fa-trash-o"></i> @lang('admin.delete')</a>
                                                </div>
                                            </div>
                                        </div>
