            ...
            <div class="row">
                <div class="col-md-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="hpanel">
                        ...
                        <form id="msg-list" action="{{ route('member.email.delete-multiple-inbox') }}" method="post">
                            @csrf
                                    ...
                                    <table class="table table-hover table-mailbox">
                                        ...
                                        @foreach($emails as $item)
                                            ...
                                            <tr @if($item->pivot->read==0) class="unread" @endif >
                                                ...
                                                <td>
                                                    <a  href="{{ route('member.email.delete-inbox',['email'=>$item->id]) }}"  title="@lang('site.delete')" onclick="return confirm('@lang('admin.delete-prompt')')" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
