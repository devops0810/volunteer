...
return [
    ...
    'ends_with' => 'Атрибут: должен заканчиваться одним из следующих значений:attribute values',
    ...
    'required_if' => 'Поле: атрибут обязательно, когда: other is: value',
    ...
    'required_without_all' => 'Поле: attribute является обязательным, если нет ни одного из:',
